...
# ---------------- 設定（System Update/MatchMist 完結版） ----------------
VERSION_PREFIX = "v39.30"  # 必要に応じて変更

PROFILE_NAME = "MatchMist"
...
# ---- パス（System Update/MatchMist 内で完結） ----
...
PATH_LOOTDATA_DIR = str(COMMON_DIR / "戦利品データ" / "Reload" / "MatchMist" )
...
HOTFIX_LP_LOCAL_PATHS = [
    ...
    "e:/Fmodel/Exports/FortniteGame/Plugins/GameFeatures/BlastBerryLoot/Content/DataTables/MatchMist/MatchMistLootPackages.json",
]
HOTFIX_LP_API_PATHS = [
    ...
    "http://localhost:3849/api/v1/export?path=FortniteGame/Plugins/GameFeatures/BlastBerryLoot/Content/DataTables/MatchMist/MatchMistLootPackages.uasset",
]
...
HOTFIX_LP_TARGETS = [
    ...
    "/BlastBerryLoot/DataTables/MatchMist/MatchMistLootPackages"
]
