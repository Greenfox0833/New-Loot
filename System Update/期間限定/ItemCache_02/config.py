...
HOTFIX_LP_API_PATHS = [
    "http://localhost:3849/api/v1/export?path=FortniteGame/Plugins/GameFeatures/RA_ItemCache_ItemSet2/Content/DataTables/ItemCache_02_LootPackages.uasset",
]
...
HOTFIX_LT_API_PATHS = [
    "http://localhost:3849/api/v1/export?path=FortniteGame/Plugins/GameFeatures/RA_ItemCache_ItemSet2/Content/DataTables/ItemCache_02_LootTierData.uasset",
]
