...
def main():
    ...
    ap.add_argument("--current", "-c", type=Path, default=Path("e:/Fmodel/Exports/FortniteGame/Plugins/GameFeatures/LootCurrentSeason/Content/DataTables/LootCurrentSeasonLootPackages_Client.json"),
                    help="ベース（追記先）JSONパス")
    ap.add_argument("--athena", "-a", type=Path, default=Path("e:/Fmodel/Exports/FortniteGame/Content/Items/DataTables/AthenaLootPackages_Client.json"),
                    help="追記元（Athena）JSONパス")
    ap.add_argument("--out", "-o", type=Path, default=Path("e:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/BR/作業用/Json_Package合成.json"),
                    help="出力先 JSON パス")
