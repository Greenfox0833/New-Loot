...
INPUT_MINLIST_JSON = r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/Reload/Sunflower/items_unique_min.json"


# 画像の保存先（親）:  <OUTPUT_BASE_DIR>/<TierGroup>/<WorldListKey>/ に振り分け保存
OUTPUT_BASE_DIR = r"E:/フォートナイト/Picture/Loot Pool/TEST4/アイテム画像/Reload/Sunflower"
...
def main():
    ...
    loot_summary_py  = Path(r"e:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/Reload/Sunflower/LootSummary.py")
    version_save_dir = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/Sunflower")  # まとめJSONの保存先
    lt_json_path     = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/Reload/Sunflower/AthenaLootTierData_Client__final_LT.json")
    lp_json_path     = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/Reload/Sunflower/AthenaLootPackages_Client__final_LP.json")
    ...
    try:
        ...
        # 0) Hotfix（必要時のみ実行）
        if DO_HOTFIX:
            subprocess.run([sys.executable, r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/Reload/Sunflower/LootPackage更新.py"], check=True)
        ...
        br_lootdata_dir = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/Reload/Sunflower/LootPercent")
        br_lootdata_dir.mkdir(parents=True, exist_ok=True)
        br_out = br_lootdata_dir / f"Reload_Sunflower_LootData_{br_now}.json"
        ...
        print(f"✅ Reload_Sunflower_LootData を作成: {br_out}")
        ...
        try:
            ...
            msg = f"Reload Sunflower update {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}"
        ...
        print("===== Reload Sunflower: pipeline end =====")
