...
WEB_LOOTPOOL_OUT = r"E:/フォートナイト/Web/loot/data/ItemCache_02_LootPool.json"
...
def _setup_logger():
    ...
    logger = logging.getLogger("pipeline_ItemCache_02")
    if logger.handlers:
        return logger
...
def main():
    ...
    try:
        logger.info("===== ItemCache_02: pipeline start =====")
        ...
        try:
            ...
            msg = f"ItemCache_02 update {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}"
        ...
        logger.info("===== ItemCache_02: pipeline end =====")
