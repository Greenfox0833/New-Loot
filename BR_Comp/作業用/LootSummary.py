...
# ===== 既定パス（/ でOK） =====
DEFAULT_SCAN_DIR      = "E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/BR_Comp"
DEFAULT_DIFF_SCAN_DIR = "E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/BR_Comp"
...
def main():
    ...
    extract_dir = r"E:\フォートナイト\Picture\Loot Pool\TEST4\New Loot\BR_Comp\作業用"
    ...
    diff_dir = os.path.join(HISTORY_BASE_DIR, f"BR_Comp_{now.strftime('%Y%m%d_%H%M')}")
    ensure_dir(diff_dir)
