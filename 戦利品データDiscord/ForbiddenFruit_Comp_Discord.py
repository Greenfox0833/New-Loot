...
# ===== 設定 =====
BASE_DIR = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/ForbiddenFruit_Comp")
...
# ここに追加する 👇
IMAGE_ROOT = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/アイテム画像/ForbiddenFruit_Comp")
...
def send_one_weapon(weapon_name: str, rarity: str, weapon_id: str, items: List[Dict], with_content: bool = False):
    ...
    if with_content:
        payload = {
            "content": "**Blitz Royale（競技）の戦利品データ更新**",
            "embeds": [embed]
        }
    else:
        payload = {"embeds": [embed]}
