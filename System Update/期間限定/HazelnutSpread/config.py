...
HOTFIX_LP_API_PATHS = [
    "http://localhost:3849/api/v1/export?path=FortniteGame/Plugins/GameFeatures/HazelnutSpread/Content/DataTables/HazelnutSpread_AthenaLootPackages.uasset",
    "http://localhost:3849/api/v1/export?path=FortniteGame/Plugins/GameFeatures/HazelnutSpread/Content/DataTables/HazelnutSpread_AthenaLootPackages_Override.uasset",
]
...
HOTFIX_LP_API_PATHS = [
    "http://localhost:3849/api/v1/export?path=FortniteGame/Plugins/GameFeatures/RA_ItemCache_ItemSet1/Content/DataTables/ItemCache_01_LootPackages.uasset",
]
HOTFIX_LP_PATHS = HOTFIX_LP_API_PATHS if HOTFIX_SOURCE == "api" else HOTFIX_LP_LOCAL_PATHS
HOTFIX_LP_MAX_PATHS = 10
...
HOTFIX_LT_API_PATHS = [
    "http://localhost:3849/api/v1/export?path=FortniteGame/Plugins/GameFeatures/RA_ItemCache_ItemSet1/Content/DataTables/ItemCache_01_LootTierData.uasset",
]
...
HOTFIX_LT_TARGETS = [
    "/HazelnutSpread/DataTables/HazelnutSpread_AthenaLootTierData",
    "/HazelnutSpread/DataTables/HazelnutSpread_AthenaLootTierData_Override"
]
