...
# 出力先
OUT_FINAL = Path(
    "E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/Reload/PunchBerry/AthenaLootPackages_Client__final_LP.json"
)
...
HOTFIX_TARGET_BB_PARENT4 = "/BlastBerryLoot/DataTables/PunchBerry/PunchBerryLootPackages"
