...
def main():
    # ====== 設定 ======
    # LootSummary の場所
    loot_summary = Path(r"e:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/Figment_NoBuild/LootSummary.py")
    # LootSummary のスキャン対象（履歴を置いている場所）
    version_save_dir = r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/Figment_NoBuild"
