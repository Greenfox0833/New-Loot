...
# ===== 既定パス（/ でOK） =====
DEFAULT_SCAN_DIR      = "E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/Reload_NoBuild"
DEFAULT_DIFF_SCAN_DIR = "E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/Reload_NoBuild"
...
def main():
    ...
    extract_dir = r"E:\フォートナイト\Picture\Loot Pool\TEST4\New Loot\Reload_NoBuild"
    ...
    diff_dir = os.path.join(HISTORY_BASE_DIR, f"Reload_NoBuild_{now.strftime('%Y%m%d_%H%M')}")
    ensure_dir(diff_dir)
