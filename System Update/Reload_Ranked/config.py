...
PATH_LOOTDATA_DIR = str(COMMON_DIR / "戦利品データ" / "Reload_Ranked" )
PATH_REPO_DIR = str(PROJECT_ROOT)

# Hotfix入力元: "api" または "local"
HOTFIX_SOURCE = "api"
if HOTFIX_SOURCE not in {"api", "local"}:
    raise ValueError('HOTFIX_SOURCE は "api" または "local" を指定してください')
