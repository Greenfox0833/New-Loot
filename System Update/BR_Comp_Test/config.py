...
PATH_LOOTDATA_DIR = str(COMMON_DIR / "戦利品データ" / PROFILE_NAME)
...
HOTFIX_LT_TARGETS = [
    ...
    "/CosmicThunderLoot/DataTables/Comp/CosmicThunder_Override_LootTiers_Comp"
]
