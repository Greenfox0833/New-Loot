...
FIGMENT_LTD_BACKUP_PATH = Path(r"e:/Fmodel/Exports/FortniteGame/Plugins/GameFeatures/Figment/Figment_LootTables/Content/DataTables/FigmentLootTierData_Backup.json")
HOTFIX_INI_PATH         = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/Hotfix/Hotfix.ini")  # 無ければ自動スキップ

OUT_FINAL               = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/Figment/FigmentLootTierData__final.json")
# =====================================================
