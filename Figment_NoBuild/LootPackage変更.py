...
FIGMENT_BACKUP_PATH = Path(r"e:/Fmodel/Exports/FortniteGame/Plugins/GameFeatures/Figment/Figment_LootTables/Content/DataTables/NoBuild/NoBuildFigmentLootPackages_Override.json")
HOTFIX_INI_PATH     = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/Hotfix/Hotfix.ini")  # 無ければ自動スキップ

OUT_FINAL           = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/Figment_NoBuild/FigmentLootPackages__final.json")
# =====================================================
