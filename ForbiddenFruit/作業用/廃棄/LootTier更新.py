...
json_path = "e:/Fmodel/Exports/FortniteGame/Plugins/GameFeatures/ForbiddenFruitDataTables/Content/DataTables/ForbiddenFruitChapterLootTierData.json" #変更しない
output_path = "E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/ForbiddenFruit/作業用/Updated_LootTier.json"
...
# 対象データテーブル名（完全一致）
target_table_name = "/ForbiddenFruitDataTables/DataTables/ForbiddenFruitChapterLootTierData"
