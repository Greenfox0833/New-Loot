...
HOTFIX_LP_LOCAL_PATHS = [
    "e:/Fmodel/Exports/FortniteGame/Plugins/GameFeatures/RA_ItemCache_ItemSet2/Content/DataTables/ItemCache_02_LootPackages.json"
]
HOTFIX_LP_API_PATHS = [
    "https://export-service.dillyapis.com/v1/export/?Path=FortniteGame/Plugins/GameFeatures/RA_ItemCache_ItemSet2/Content/DataTables/ItemCache_02_LootPackages.uasset",
]
...
HOTFIX_LP_TARGETS = [
    "/RA_ItemCache_ItemSet2/DataTables/ItemCache_02_LootPackages"
]

# Hotfix設定（LootTier）
HOTFIX_LT_LOCAL_PATHS = [
    "e:/Fmodel/Exports/FortniteGame/Plugins/GameFeatures/RA_ItemCache_ItemSet2/Content/DataTables/ItemCache_02_LootTierData.json"
]
HOTFIX_LT_API_PATHS = [
    "https://export-service.dillyapis.com/v1/export/?Path=FortniteGame/Plugins/GameFeatures/RA_ItemCache_ItemSet2/Content/DataTables/ItemCache_02_LootTierData.uasset",
]
...
HOTFIX_LT_TARGETS = [
    "/RA_ItemCache_ItemSet2/DataTables/ItemCache_02_LootTierData"
]
