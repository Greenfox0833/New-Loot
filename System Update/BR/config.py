...
# 画像の保存先
OUTPUT_BASE_DIR = str(COMMON_DIR / "shared" / "images")
...
PATH_HOTFIX_LP = str(SCRIPTS_DIR / "LootPackage変更.py")
PATH_HOTFIX_LT = str(SCRIPTS_DIR / "LootTier変更.py")
...
PATH_LOOTDATA_DIR = str(COMMON_DIR / "lootdata" / "BR" / "LootPercent")
