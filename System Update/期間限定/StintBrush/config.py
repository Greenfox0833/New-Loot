...
HOTFIX_LP_API_PATHS = [
    "http://localhost:3849/api/v1/export?path=FortniteGame/Plugins/GameFeatures/StintBrushLoot/Content/DataTables/StintBrushLoot_LootPackages.uasset",
]
...
HOTFIX_LT_API_PATHS = [
    "http://localhost:3849/api/v1/export?path=FortniteGame/Plugins/GameFeatures/StintBrushLoot/Content/DataTables/StintBrushLoot_LootTierData.uasset",
]
