...
# ---------------- 設定（System Update/Sunflower 完結版） ----------------
VERSION_PREFIX = "v39.30"  # 必要に応じて変更

PROFILE_NAME = "Sunflower"
...
# ---- パス（System Update/Sunflower 内で完結） ----
...
PATH_LOOTDATA_DIR = str(COMMON_DIR / "戦利品データ" / "Reload" / "Sunflower" )
...
HOTFIX_LP_TARGETS = [
    ...
    "/BlastBerryLoot/DataTables/Sunflower/SunflowerLootPackages"
]
