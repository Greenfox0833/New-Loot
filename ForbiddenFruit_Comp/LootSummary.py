...
# ===== 既定パス（/ でOK） =====
DEFAULT_SCAN_DIR      = "E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/ForbiddenFruit_Comp"
DEFAULT_DIFF_SCAN_DIR = "E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/ForbiddenFruit_Comp"
...
def main():
    ...
    extract_dir = r"E:\フォートナイト\Picture\Loot Pool\TEST4\New Loot\ForbiddenFruit_Comp"
    ...
    diff_dir = os.path.join(HISTORY_BASE_DIR, f"ForbiddenFruit_Comp_{now.strftime('%Y%m%d_%H%M')}")
    ensure_dir(diff_dir)
