...
def main():
    br_discord = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データDiscord/Figment_NoBuild_Discord.py")
    ...
    try:
        ...
        try:
            ...
            print("✅ Figment_NoBuild_Discord を実行しました（finally）")
        except Exception as e:
            print("[!] Figment_NoBuild_Discord 実行に失敗:", e)
