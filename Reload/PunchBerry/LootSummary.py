...
# ===== 既定パス（/ でOK） =====
DEFAULT_SCAN_DIR      = "E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/Reload/PunchBerry"
DEFAULT_DIFF_SCAN_DIR = "E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/Reload/PunchBerry"
...
def main():
    ...
    extract_dir = r"E:\フォートナイト\Picture\Loot Pool\TEST4\New Loot\Reload\PunchBerry"
    ...
    diff_dir = os.path.join(HISTORY_BASE_DIR, f"Reload_PunchBerry_{now.strftime('%Y%m%d_%H%M')}")
    ensure_dir(diff_dir)
