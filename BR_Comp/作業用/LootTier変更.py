...
HOTFIX_TARGET_SEASON = "LootCurrentSeasonLootTierData_Client"
HOTFIX_TARGET_COMP   = "LootCurrentSeasonLootTierData_Client_Comp"
...
def main():
    ...
    # ④ Hotfix（LootCurrentSeasonLootTierData_Client_Comp だけ）
    if HOTFIX_PATH.exists():
        text = HOTFIX_PATH.read_text(encoding="utf-8")
