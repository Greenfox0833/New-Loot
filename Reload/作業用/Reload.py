...
OUTPUT_BASE_DIR = r"E:/フォートナイト/Picture/Loot Pool/TEST4/アイテム画像/Reload"
...
def main():
    br_discord = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データDiscord/Reload_Discord.py")
    version_save_dir = r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/Reload"
    ...
    try:
        ...
        try:
            ...
            print("✅ Reload_Discord を実行しました（finally）")
        except Exception as e:
            print("[!] Reload_Discord 実行に失敗:", e)
