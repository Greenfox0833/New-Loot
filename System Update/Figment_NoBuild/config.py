...
HOTFIX_LP_API_PATHS = [
    ...
    "http://localhost:3849/api/v1/export?path=FortniteGame/Plugins/GameFeatures/Figment/Figment_LootTables/Content/DataTables/NoBuild/NoBuildFigmentLootPackages_Override.uasset",
]
...
HOTFIX_LT_API_PATHS = [
    ...
    "http://localhost:3849/api/v1/export?path=FortniteGame/Plugins/GameFeatures/Figment/Figment_LootTables/Content/DataTables/NoBuild/NoBuildFigmentLootTierData_Override.uasset",
]
