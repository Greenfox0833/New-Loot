...
json_path = "e:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/BR/作業用/Json_Package合成.json"  # 変更しない
output_path = "E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/BR/作業用//Updated_LootPackages.json"  # 変更しない
...
with open(hotfix_path, "r", encoding="utf-8") as f:
    for line in f:
        ...
        # Weightの更新処理
        if (
            "LootCurrentSeasonLootPackages_Client" in line and
