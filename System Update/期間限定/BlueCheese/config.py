...
HOTFIX_LP_PATHS = [
    "e:/Fmodel/Exports/FortniteGame/Plugins/GameFeatures/LTM/BlueCheese/Content/DataTables/AthenaLootPackages_BlueCheese.json",
...
HOTFIX_LP_TARGETS = [
    "/BlueCheese/DataTables/AthenaLootPackages_BlueCheese",
    "/BlueCheese/DataTables/OverrideLootPackagesDataBackup_BlueCheese",
]

# Hotfix設定（LootTier）
HOTFIX_LT_PATHS = [
    "e:/Fmodel/Exports/FortniteGame/Plugins/GameFeatures/LTM/BlueCheese/Content/DataTables/AthenaLootTierData_BlueCheese.json",
...
HOTFIX_LT_TARGETS = [
    "/BlueCheese/DataTables/AthenaLootTierData_BlueCheese",
    "/BlueCheese/DataTables/OverrideLootTierDataBackup_BlueCheese",
]
