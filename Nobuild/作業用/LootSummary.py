...
# ===== 既定パス（/ でOK） =====
DEFAULT_SCAN_DIR      = "E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/NoBuild"
DEFAULT_DIFF_SCAN_DIR = "E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/NoBuild"
...
def main():
    ...
    extract_dir = r"E:\フォートナイト\Picture\Loot Pool\TEST4\New Loot\NoBuild\作業用"
    ...
    diff_dir = os.path.join(HISTORY_BASE_DIR, f"NoBuild_{now.strftime('%Y%m%d_%H%M')}")
    ensure_dir(diff_dir)
