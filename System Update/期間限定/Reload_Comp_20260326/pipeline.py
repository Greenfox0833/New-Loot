...
WEB_LOOTPOOL_NAME = "Reload_Comp_20260326_LootPool.json"
...
def _setup_logger():
    ...
    logger = logging.getLogger("pipeline_Reload_Comp_20260326")
    if logger.handlers:
        return logger
...
def main():
    ...
    try:
        logger.info("===== Reload_Comp_20260326: pipeline start =====")
        ...
        try:
            ...
            msg = f"Reload_Comp_20260326 update {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}"
        ...
        logger.info("===== Reload_Comp_20260326: pipeline end =====")
