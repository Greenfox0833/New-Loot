...
INPUT_LP_JSON = r"e:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/NoBuild_Comp/作業用/AthenaCompositeLP_NoBuildBR_Comp_Merged_Hotfix.json"
...
import subprocess
if DO_HOTFIX:
    subprocess.run(["python", r"e:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/NoBuild_Comp/作業用/LP_NoBuildLP合体.py"], check=True)
# --- Hotfix適用ここまで ---
...
def main():
    br_discord = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データDiscord/Nobuild_Comp_Discord.py")
    version_save_dir = r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/Nobuild_Comp"
    ...
    try:
        ...
        try:
            ...
            print("✅ Nobuild_Comp_Discord を実行しました（finally）")
        except Exception as e:
            print("[!] Nobuild_Comp_Discord 実行に失敗:", e)
