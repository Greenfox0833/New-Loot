...
# ---------------- 設定（System Update/PunchBerry 完結版） ----------------
VERSION_PREFIX = "v39.30"  # 必要に応じて変更

PROFILE_NAME = "PunchBerry"
...
# ---- パス（System Update/PunchBerry 内で完結） ----
...
PATH_LOOTDATA_DIR = str(COMMON_DIR / "戦利品データ" / "Reload" / "PunchBerry" )
...
HOTFIX_LP_LOCAL_PATHS = [
    ...
    "e:/Fmodel/Exports/FortniteGame/Plugins/GameFeatures/BlastBerryLoot/Content/DataTables/BlastBerry_AthenaLootPackages_Unranked.json",
    "e:/Fmodel/Exports/FortniteGame/Plugins/GameFeatures/BlastBerryLoot/Content/DataTables/PunchBerry/PunchBerryLootPackages.json",
]
HOTFIX_LP_API_PATHS = [
    ...
    "https://export-service.dillyapis.com/v1/export/?Path=FortniteGame/Plugins/GameFeatures/BlastBerryLoot/Content/DataTables/PunchBerry/PunchBerryLootPackages.uasset",
]
...
HOTFIX_LP_TARGETS = [
    ...
    "/BlastBerryLoot/DataTables/BlastBerry_AthenaLootPackages_Unranked",
    "/BlastBerryLoot/DataTables/PunchBerry/PunchBerryLootPackages"
]
