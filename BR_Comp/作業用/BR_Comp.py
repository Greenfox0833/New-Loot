...
def main():
    # ====== 設定 ======
    # LootSummary の場所
    loot_summary = Path(r"e:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/BR_Comp/作業用/LootSummary.py")
    ...
    br_discord = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データDiscord/BR_Comp_Discor.py")
