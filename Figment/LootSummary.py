...
# ===== 既定パス（/ でOK） =====
DEFAULT_SCAN_DIR      = "E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/Figment"
DEFAULT_DIFF_SCAN_DIR = "E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/Figment"
...
def main():
    ...
    extract_dir = r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/Figment"
    ...
    diff_dir = os.path.join(HISTORY_BASE_DIR, f"Figment_{now.strftime('%Y%m%d_%H%M')}")
    ensure_dir(diff_dir)
