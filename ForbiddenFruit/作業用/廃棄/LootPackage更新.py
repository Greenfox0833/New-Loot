...
json_path = "e:/Fmodel/Exports/FortniteGame/Plugins/GameFeatures/ForbiddenFruitDataTables/Content/DataTables/ForbiddenFruitChapterLootPackages.json"  # 変更しない
output_path = "E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/ForbiddenFruit/作業用//Updated_LootPackages.json"  # 変更しない
...
with open(hotfix_path, "r", encoding="utf-8") as f:
    for line in f:
        ...
        # Weightの更新処理
        if (
            "ForbiddenFruitChapterLootPackages" in line and
