...
# ---------------- 設定（System Update/DashBerry 完結版） ----------------
VERSION_PREFIX = "v39.30"  # 必要に応じて変更

PROFILE_NAME = "DashBerry"
...
# ---- パス（System Update/DashBerry 内で完結） ----
...
PATH_LOOTDATA_DIR = str(COMMON_DIR / "戦利品データ" / "Reload" / "DashBerry" )
...
HOTFIX_LP_LOCAL_PATHS = [
    ...
    "e:/Fmodel/Exports/FortniteGame/Plugins/GameFeatures/BlastBerryLoot/Content/DataTables/DashBerry/DashBerryLootPackages.json",
]
HOTFIX_LP_API_PATHS = [
    ...
    "https://export-service.dillyapis.com/v1/export/?Path=FortniteGame/Plugins/GameFeatures/BlastBerryLoot/Content/DataTables/DashBerry/DashBerryLootPackages.uasset",
]
...
HOTFIX_LP_TARGETS = [
    ...
    "/BlastBerryLoot/DataTables/DashBerry/DashBerryLootPackages"
]
