...
OUTPUT_BASE_DIR = r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/ForbiddenFruit/Week10 - Phase1"
...
ASSET_LOC_CACHE_FILE = str(BASE_DIR / "asset_localize_cache.json")
try:
...
def main():
    ...
    versioned_filename = get_next_version_filename(
        VERSION_PREFIX,
        r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/ForbiddenFruit/作業用/Summary"
    )
...
import atexit
atexit.register(_flush_all_caches_now)
