...
# ===== 設定 =====
BASE_DIR = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/NoBuild_Comp")
...
# ここに追加する 👇
IMAGE_ROOT = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/アイテム画像/NoBuild_Comp")
