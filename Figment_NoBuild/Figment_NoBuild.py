...
INPUT_MINLIST_JSON = r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/Figment_NoBuild/items_unique_min.json"
...
def main():
    # ===== パス設定 =====
    br_discord       = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データDiscord/Figment_NoBuild_Discor.py")
    loot_summary_py  = Path(r"e:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/Figment_NoBuild/LootSummary.py")
    version_save_dir = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/Figment_NoBuild")  # まとめJSONの保存先
    lt_json_path     = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/Figment_NoBuild/FigmentLootTierData__final.json")
    lp_json_path     = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/Figment_NoBuild/FigmentLootPackages__final.json")
    ...
    try:
        ...
        # 0) Hotfix（必要時のみ実行）
        if DO_HOTFIX:
            subprocess.run([sys.executable, r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/Figment_NoBuild/LootPackage変更.py"], check=True)
            subprocess.run([sys.executable, r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/Figment_NoBuild/LootTier変更.py"], check=True)
            print("✓ Hotfix 適用完了")
        ...
        try:
            ...
            msg = f"Figment_NoBuild update {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}"
        ...
        print("===== Figment_NoBuild: pipeline end =====")
