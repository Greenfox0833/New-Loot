...
HOTFIX_LP_API_PATHS = [
    ...
    "http://localhost:3849/api/v1/export?path=FortniteGame/Plugins/GameFeatures/BlastBerryLoot/Content/DataTables/NoBuild/AthenaLootPackages_Client_BlastBerryOverride_NoBuild.uasset",
]
