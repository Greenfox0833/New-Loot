...
# ---------------- 設定（System Update/PiperBoot 完結版） ----------------
VERSION_PREFIX = "v39.30"  # 必要に応じて変更

PROFILE_NAME = "PiperBoot"
...
# ---- パス（System Update/PiperBoot 内で完結） ----
...
PATH_LOOTDATA_DIR = str(COMMON_DIR / "戦利品データ" / "Reload" / "PiperBoot" )
...
HOTFIX_LP_LOCAL_PATHS = [
    ...
    "e:/Fmodel/Exports/FortniteGame/Plugins/GameFeatures/BlastBerryLoot/Content/DataTables/PiperBoot/PiperBootLootPackages.json",
]
HOTFIX_LP_API_PATHS = [
    ...
    "https://export-service.dillyapis.com/v1/export/?Path=FortniteGame/Plugins/GameFeatures/BlastBerryLoot/Content/DataTables/PiperBoot/PiperBootLootPackages.uasset",
]
...
HOTFIX_LP_TARGETS = [
    ...
    "/BlastBerryLoot/DataTables/PiperBoot/PiperBootLootPackages"
]
