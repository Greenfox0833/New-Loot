...
HOTFIX_LT_API_PATHS = [
    ...
    "http://localhost:3849/api/v1/export?path=FortniteGame/Plugins/GameFeatures/BlastBerryLoot/Content/DataTables/NoBuild/AthenaLootTierData_Client_BlastBerryOverride_NoBuild.uasset",
]
