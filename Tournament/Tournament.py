...
OUTPUT_BASE_DIR = r"E:/フォートナイト/Picture/Loot Pool/TEST4/アイテム画像/Tournament"
...
def main():
    ...
    lp_json_path     = Path(r"Tournament/AthenaCompositeLP_Showdown__final.json")
    ...
    try:
        ...
        br_lootdata_dir = Path(r"E:/フォートナイト/Picture/Loot Pool/TEST4/New Loot/戦利品データ/Tournament/LootPercent")
        br_lootdata_dir.mkdir(parents=True, exist_ok=True)
        br_out = br_lootdata_dir / f"Tournament_LootData_{br_now}.json"
        ...
        print(f"✅ Tournament_LootData を作成: {br_out}")
